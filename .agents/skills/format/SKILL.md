---
name: 'format'
description: 'Formats all files using Ruff to maintain stylistic consistency.'
---

# Objective
Run the format review hook and interpret the results to ensure code quality.
...
# Integration
This skill can be invoked via the path `/format` by the `review` agent.
